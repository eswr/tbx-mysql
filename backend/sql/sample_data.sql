-- Artha sample data: 10 banks, 10 accounts, 10 transactions
-- For realistic manual integration testing (artha_sample database)
-- Exact values from TBX - Database Schema.md
...
-- Account data (10 rows)
-- Note: program_id normalized from string to integer (04 → 4)
...
-- Transaction data (10 rows)
-- Backticks around transaction table name as required by MySQL SQL
